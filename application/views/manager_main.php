        ...
        <dl id="menu-system">
            ...
            <dd style="display:block;">
                <ul>
                    ...
                    <li><a _href="<?php echo base_url();?>index.php/manager/upload" data-title="上传图片" href="javascript:void(0)">上传图片</a></li>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active"><span title="我的桌面" data-href="welcome.html">配置信息</span><em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?php echo base_url();?>index.php/manager/peizhi"></iframe>
        </div>
    </div>
</section>
